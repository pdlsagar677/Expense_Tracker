      ...
      <tbody>
        <tr style="width:100%">
          <td><img alt="Koala" height="50" src="https://react-email-demo-k6qpz0pxq-resend.vercel.app/static/koala-logo.png" style="display:block;outline:none;border:none;text-decoration:none;margin:0 auto" width="170" />
            ...
            <p style="font-size:16px;line-height:26px;margin:16px 0">Welcome to expense tracker , the sales intelligence platform that helps you uncover qualified leads and close deals faster.</p>
            ...
            <p style="font-size:16px;line-height:26px;margin:16px 0">Best,<br />The Expense team</p>
            <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#cccccc;margin:20px 0" />
            <p style="font-size:12px;line-height:24px;margin:16px 0;color:#8898aa">470 Noor Ave STE B #1148, Nepal, CA 94080</p>
          </td>
        </tr>
      </tbody>
    </table><!--/$-->
